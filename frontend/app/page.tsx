      ...
      <section className="hero-card">
        <div className="hero-copy">
          ...
          <p className="hero-body">
            ...
            的人格，再启动一个连续运行的 runtime，让 scene_01_intro、scene_02_free_talk、scene_03_random_date、scene_04_group_dinner、scene_05_conversation_choosing、scene_06_private_signal 和 scene_07_new_date
            在同一局里形成真实的多人多轮关系图。
          </p>
          <div className="hero-metrics">
            ...
            <article>
              <strong>七场连续 runtime</strong>
              <span>scene_01_intro 建立张力，scene_02_free_talk 拉开偏好，scene_03_random_date 触发意外连接，scene_04_group_dinner 放大多人竞争，scene_05_conversation_choosing 明确主动选择方向，scene_06_private_signal 揭示私密信号与期待落差，scene_07_new_date 进入主动邀约竞争。</span>
            </article>
            <article>
